...
class DepartementCustomSerializer(serializers.ModelSerializer) : 
    class Meta : 
        ...
        fields = ("id",
                  "name",
                  "code",)
class UserHospitalMemberShipCustomSerializer(serializers.ModelSerializer) : # Todo  : Should Check With Last V
    ...
    departement         = DepartementCustomSerializer(read_only = True)

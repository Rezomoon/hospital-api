...
SECRET_KEY = 'django-insecure-7_s0(x2sgc$-g6kewt=)mf5#4v0=#l#awwkzfqlk+i#6&#fbd6'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Cors Headers Middle Ware
...
# and it add to INSTALLED APPS :     
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': SECRET_KEY, # if we remove this it allow us to override default settings
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
    'JWK_URL': None,
